...
```{r, results = "asis", fig.align = 'center', fig.show="hold", warning=FALSE}
for (i in 1:10){
  cat("  \n##",  KEGGhsa[rank_pathways[i]]$MODULES$Title, "  \n")
  fig <- group_comparison(data, metaInfo, KEGGhsa[rank_pathways[i]])
